 ...
 export default TelaLogin 
    ...
    <View style={[styles.container, styles.borda]}>
     ...
     <Text style={[styles.title, styles.borda]}>Bem-vindo</Text>
      ...
      <TextInput style={[styles.input, styles.borda]} placeholder="Email" 
      placeholderTextColor="#999" /> 
      

      <TextInput style={[styles.input, styles.borda]} placeholder="Senha" 
      ...
      <Pressable
      style={[styles.footerText, styles.borda]}> Esqueceu sua senha? </Pressable> 
      </View> ); } 
